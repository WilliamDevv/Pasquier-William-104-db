        ...
        try:
            ...
            with MaBaseDeDonnee().connexion_bd.cursor() as mc_afficher:
                ...
                if id_scan_sel == 0:
                    ...
                    strsql_avoir_genre_afficher_data += """ HAVING id_film= %(value_id_scan_selected)s"""
...
def update_genre_film_selected():
    if request.method == "POST":
        try:
            ...
            new_lst_int_genre_film_old = list(map(int, new_lst_str_avoir_genre))
            ...
            lst_diff_genres_delete_b = list(
                set(old_lst_data_avoir_genre_attribues) - set(new_lst_int_genre_film_old))
            ...
            lst_diff_genres_insert_a = list(
                set(new_lst_int_genre_film_old) - set(old_lst_data_avoir_genre_attribues))
    ...
    return redirect(url_for('films_genres_afficher', id_scan_sel=id_film_selected))
